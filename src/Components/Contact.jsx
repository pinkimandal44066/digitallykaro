...
//     const serviceId = "service_ejx1sii"; 
    ...
    <div className="bg-gray-50">
      <div className="relative bg-purple-700 py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-blue-200 mt-4">Let's start a conversation. We’d love to hear from you!</p>
        </div>
      </div>

      <div className="relative -mt-12 z-10">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="bg-white shadow-lg rounded-lg p-8 text-center hover:shadow-xl transition duration-300" data-aos="fade-up">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Our Address</h3>
            <p className="text-gray-600">123 IT Park, Tech Street, Dhanbad</p>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-8 text-center hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="200">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Phone</h3>
            <p className="text-gray-600">+91 98765 43210</p>
            <p className="text-gray-500 text-sm mt-2">Mon - Fri, 9:00am - 6:00pm</p>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-8 text-center hover:shadow-xl transition duration-300" data-aos="fade-up" data-aos-delay="400">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Email</h3>
            <p className="text-gray-600">info@itcompany.com</p>
            <p className="text-gray-600 mt-2">support@itcompany.com</p>
          </div>
      ...
      <section
        id="contact"
        className="py-16 mt-8 px-4 md:px-8 lg:px-20"
      >
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:space-x-12 justify-center">
            <div className="w-full mb-12 md:mb-0" data-aos="fade-right">
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                <h3 className="text-2xl md:text-4xl text-[#6A0DAD] font-semibold mb-6">Enquiry</h3>
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#6A0DAD] text-white py-2 rounded-md hover:bg-[#5a0c93] transition duration-200"
                  >
                    Send Message
                  </button>
                </form>
            ...
            {/* Yahan Google Map ko hata diya gaya hai */}
          </div>
        </div>
      </section>
    </div>
